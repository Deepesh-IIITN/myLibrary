...
<body>
     <div style="height:60px;width:100%;">
		 ...
		 <input type="submit" value="Logout" style="cursor:pointer;float:right;margin-top:20px;margin-right:20px;height:40px;width:100px;background-color:green;color:white;border:0px;border-radius:15px;">
         </form>
	 </div>
	 <hr>
     <div style="height:90%;width:30%;background-color:#e6f7ff;float:left;">
         ...
         $con = mysqli_connect('localhost','root','','library');
					...
					if($run==TRUE)
                    {
                        ...
                        {
							$slag=1;
							if($_SESSION['stu_email']==$data['email'])
                            {
                                ?>
